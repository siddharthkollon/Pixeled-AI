...
Model = ChatGroq(model="openai/gpt-oss-120b",groq_api_key=groq_api_key,max_completion_tokens=8000,reasoning_effort="high")
...
- The code you make should be complete,the game should be complete and playable
